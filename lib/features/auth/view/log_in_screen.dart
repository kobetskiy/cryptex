    ...
    return BlocConsumer<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state is AuthFailure) {
          // Показываем SnackBar с сообщением ошибки
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                state.error,
                style: TextStyle(color: const Color.fromARGB(255, 180, 55, 46)),
              ),
            ),
          );
        }
        if (state is AuthSuccess) {
          // Если нужно, можно обработать успешный вход (например, навигацию)
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: TextButton(
                      ...
                      child: Text(
                        S.of(context).dontHaveAnAccountYetSignUp,
